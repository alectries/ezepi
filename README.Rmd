...
1. **mhrd**: Generates a table with an estimate and CI for a Mantel-Haenszel risk difference.
2. **mhrr**: Generates a table with an estimate and CI for a Mantel-Haenszel risk ratio.
3. **mhior**: Generates a table with an estimate and CI for a Mantel-Haenszel incidence odds ratio.

For now, mh functions wrap the corresponding fmsb functions. In the future, they will depend on ezepi::calc.
...
- Mantel-Haenszel support in calc and the full removal of fmsb dependency.
