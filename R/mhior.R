#' mhior: Mantel-Haenszel pooled odds ratio from binary exposure and outcome variables
#'
#' Returns a tibble with a 95 percent CI and estimated incidence
#' odds ratio.
#'
...
mhior <- function(x,
  ...
  ezepi:::startup(
    ...
    utils::modifyList(formals(ezepi::mhior), as.list(match.call()[-1]))
  )
